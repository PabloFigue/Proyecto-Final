...
# 2 "<built-in>" 2
# 1 "Proyecto_Micros.c" 2
# 33 "Proyecto_Micros.c"
...
# 56 "Proyecto_Micros.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\c90\\stdint.h" 1 3
# 57 "Proyecto_Micros.c" 2
...
int valor_mapeado0 = 0, valor_mapeado1 = 0, valor_mapeado2 =0 , valor_mapeado3= 0;
uint8_t address0 = 0x04;
uint8_t address1 = 0x05;
uint8_t address2 = 0x06;
uint8_t address3 = 0x07;
uint8_t valorDIAL,valorSLIDE;
...
# 106 "Proyecto_Micros.c"
    ...
    if(RCIF){
        if (modo_funcionamiento == 2 && activador_modo == 1){
            ...
            if (valorSLIDE == 0){
                ...
                selectSERVO = 3;
            }else if (valorSLIDE == 4){
                selectSERVO = 4;
            }else if (valorSLIDE == 255){
                status = 1;
                valorSLIDE = 0;
            }else {
                if (selectSERVO == 1){
...
# 213 "Proyecto_Micros.c"
    if (RBIF) {
        ...
        if (RB1 == 0) {
            activador_modo = activador_modo ^ 1;
        }
        if (RB2 == 0) {
        ...
        if (RB4 == 0) {
            if(modo_funcionamiento == 0 && activador_modo == 1){
                ...
                valor_mapeado0 = read_EEPROM(address0);
                valor_mapeado1 = read_EEPROM(address1);
                valor_mapeado2 = read_EEPROM(address2);
                valor_mapeado3 = read_EEPROM(address3);


            } else if(modo_funcionamiento == 1 && activador_modo == 1){

                write_EEPROM(address0, valor_mapeado0);
                write_EEPROM(address1, valor_mapeado1);
                write_EEPROM(address2, valor_mapeado2);
                write_EEPROM(address3, valor_mapeado3);
...
void modo_manual(void){
    while (1){
        ...
        valor_mapeado0 = map(adc00,0,255,30,60);
...
void modo_uart(void){
    while (1){
        RCSTAbits.SPEN = 1;
        TXREG = valor_mapeado0;
        _delay((unsigned long)((30)*(500000/4000.0)));
         TXREG = '\n';
        _delay((unsigned long)((30)*(500000/4000.0)));
        TXREG = valor_mapeado1;
        _delay((unsigned long)((30)*(500000/4000.0)));
         TXREG = '\n';
        _delay((unsigned long)((30)*(500000/4000.0)));
        TXREG = valor_mapeado2;
        _delay((unsigned long)((30)*(500000/4000.0)));
        TXREG = '\n';
        _delay((unsigned long)((30)*(500000/4000.0)));
        TXREG = valor_mapeado3;
        _delay((unsigned long)((30)*(500000/4000.0)));
        TXREG = '\n';
        _delay((unsigned long)((30)*(500000/4000.0)));
